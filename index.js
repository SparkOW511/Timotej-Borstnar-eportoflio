  ...
  if (count === 1) {
    document
      ...
      .parentElement.setAttribute(
        "href",
        "https://sparkow511.github.io/Starter-Portfolio/"
      );
    document
      .querySelector(".project__github")
      .parentElement.setAttribute(
        "href",
        "https://github.com/SparkOW511/Starter-Portfolio"
      );
  }
  if (count === 2) {
    document
      ...
      .parentElement.setAttribute(
        "href",
        "https://sparkow511.github.io/Wordle-Clone/"
      );
    document
      .querySelector(".project__github")
      .parentElement.setAttribute(
        "href",
        "https://github.com/SparkOW511/Wordle-Clone"
      );
  }
  if (count === 3) {
    document
      ...
      .parentElement.setAttribute(
        "href",
        "https://react-movie-trailer-app.herokuapp.com/"
      );
    document
      .querySelector(".project__github")
      .parentElement.setAttribute(
